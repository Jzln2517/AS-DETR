...
__all__ = ['BasicBlock_Attention', 'BottleNeck_Attention', 'C3_Attention', 'C2f_Attention', 'SPDConv',
           ...
           'HCCM', 'SBAWA', 'WaveletPool', 'IWP', 'SOFB', 'WTConv2d', 'LDConv','C2f_LFI', 'DFEM','ACNet','ASF',
           ]
...
class ACNet(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(CSP_ACB(self.c, self.c) for _ in range(n))
